export interface MembershipSettings {
  ...
  referral_tier_2_bonus: number        // Default 30 (2. Davet Bonusu -> Toplam 60 GǬn)
  referral_tier_3_bonus: number        // Default 60 (3. Davet Bonusu -> Toplam 90 GǬn)
  referral_tier_4_bonus: number        // Default 120 (4. Davet Bonusu -> Toplam 150 GǬn)
  referral_tier_5_bonus: number        // Default 300 (5. Davet Bonusu -> Toplam 330 GǬn)
