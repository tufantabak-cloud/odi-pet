...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      app_features: {
        Row: {
          ...
          label: string
          metadata: Json
          scope: Database["public"]["Enums"]["feature_scope_enum"]
          status: Database["public"]["Enums"]["feature_status_enum"]
          updated_at: string
        }
        Insert: {
          created_at?: string
      ...
      bundle_features: {
        ...
        Relationships: [
          {
            foreignKeyName: "bundle_features_bundle_key_fkey"
            columns: ["bundle_key"]
            isOneToOne: false
            referencedRelation: "app_bundles"
            referencedColumns: ["key"]
          },
          {
            foreignKeyName: "bundle_features_feature_key_fkey"
            columns: ["feature_key"]
            isOneToOne: false
      ...
      feature_audit_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "feature_audit_logs_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      feature_idempotency_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "feature_idempotency_logs_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      feature_kill_switches: {
        ...
        Relationships: [
          {
            foreignKeyName: "feature_kill_switches_disabled_by_fkey"
            columns: ["disabled_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      feature_limits: {
        ...
        Relationships: [
          {
            foreignKeyName: "feature_limits_feature_key_fkey"
            columns: ["feature_key"]
            isOneToOne: false
            referencedRelation: "app_features"
            referencedColumns: ["key"]
      ...
      feature_usage: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "feature_usage_pet_id_fkey"
            columns: ["pet_id"]
            isOneToOne: false
            referencedRelation: "nutrition_overview"
            referencedColumns: ["pet_id"]
      ...
      membership_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "membership_events_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      orchestrator_analytics: {
        Row: {
          ...
          event_type: Database["public"]["Enums"]["orchestrator_event_type"]
          id: string
          profile_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "orchestrator_analytics_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "orchestrator_campaigns"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "orchestrator_analytics_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "orchestrator_analytics_prompt_id_fkey"
            columns: ["prompt_id"]
            isOneToOne: false
            referencedRelation: "orchestrator_prompts"
            referencedColumns: ["id"]
          },
        ]
      }
      orchestrator_campaigns: {
        Row: {
          ...
          name: string
          start_date: string | null
          status: Database["public"]["Enums"]["orchestrator_campaign_status"]
          target_segment_rules: Json | null
      ...
      orchestrator_prompts: {
        Row: {
          ...
          created_at: string
          display_type: Database["public"]["Enums"]["orchestrator_display_type"]
          id: string
          mutation_action: string | null
          ui_config: Json | null
          updated_at: string
          version: number
        ...
        Relationships: [
          {
            foreignKeyName: "orchestrator_prompts_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "orchestrator_campaigns"
            referencedColumns: ["id"]
      ...
      plan_bundles: {
        ...
        Relationships: [
          {
            foreignKeyName: "plan_bundles_bundle_key_fkey"
            columns: ["bundle_key"]
            isOneToOne: false
            referencedRelation: "app_bundles"
            referencedColumns: ["key"]
      ...
      premium_audit_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "premium_audit_logs_admin_id_fkey"
            columns: ["admin_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "premium_audit_logs_target_profile_id_fkey"
      ...
      user_subscriptions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_subscriptions_referrer_id_fkey"
            columns: ["referrer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_complete_recurring_plan_signatures: { Args: never; Returns: Json }
      get_nearby_clinics: {
    ...
    Enums: {
      ...
      audit_action_enum:
        ...
        | "usage_recorded"
        | "usage_reset"
      feature_scope_enum: "global" | "per_pet"
      feature_status_enum: "active" | "beta" | "deprecated"
      orchestrator_campaign_status:
        | "draft"
        | "testing"
        | "scheduled"
        | "active"
        ...
        | "completed"
        | "archived"
      orchestrator_display_type: "modal" | "bottom_sheet" | "inline_banner"
      orchestrator_event_type:
        ...
        | "timeout"
        | "snoozed"
      plan_tier_enum: "free" | "pro" | "ai_plus" | "enterprise"
