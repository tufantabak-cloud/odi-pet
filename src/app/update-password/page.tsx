        ...
        {success ? (
          ...
          <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full mt-2 py-4 text-[15px] font-black shadow-xl shadow-primary/20 hover:shadow-primary/40 disabled:opacity-60 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
              {loading ? (
