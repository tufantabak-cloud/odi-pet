    ...
    <div className="flex flex-col gap-6 pb-10 w-full mx-auto">
      <div className="flex items-center gap-4 px-2 mb-2">
        <Link href="/owner/profile"
          className="w-11 h-11 rounded-full border border-border-main flex items-center justify-center text-text-secondary hover:text-primary transition-all bg-surface shrink-0 shadow-sm hover:scale-[1.05] active:scale-[0.95]">
