    ...
    <div className="flex flex-col gap-8 pb-4 w-full animate-pulse">
      ...
      <div>
        ...
        <div className="flex gap-4 overflow-hidden pb-3">
          {[1,2,3].map(i => (
            <div key={i} className="shrink-0 w-[200px] sm:w-[220px] aspect-square bg-border-main rounded-sheet"/>
          ))}
        </div>
      </div>
      ...
      <div className="card-base p-6 sm:p-8 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-3">
          {[1,2,3].map(i => (
            <div key={i} className="flex items-center gap-4 p-4 border border-border-main rounded-card">
              <div className="w-[52px] h-[52px] bg-border-main rounded-input shrink-0"/>
