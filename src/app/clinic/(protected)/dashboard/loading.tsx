  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-pulse">
      <div className="flex flex-col gap-3 pb-4 border-b border-border-main">
        <div className="h-8 w-52 bg-border-main rounded-lg"/>
      ...
      <div className="card-base p-6 flex flex-col gap-4">
        {[1,2,3,4].map(i => (
          <div key={i} className="flex items-center gap-5 p-4 border border-border-main rounded-card">
            <div className="w-16 h-14 bg-border-main rounded-input shrink-0"/>
