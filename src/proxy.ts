...
function buildCsp(): string {
  ...
  const baseCsp = `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://*.challenges.cloudflare.com https://unpkg.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://unpkg.com; img-src 'self' blob: data: https://*.supabase.co https://*.tile.openstreetmap.org https://odi.pet https://*.odi.pet; font-src 'self' data:; connect-src 'self' blob: http://127.0.0.1:* http://localhost:* https://*.supabase.co wss://*.supabase.co https://challenges.cloudflare.com https://*.challenges.cloudflare.com https://*.cloudflare.com https://api.resend.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://odi.pet https://*.odi.pet; frame-src 'self' https://challenges.cloudflare.com https://*.challenges.cloudflare.com; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';`
