...
// 22_component-library.md matrix: "OPModal | Modal.tsx | rounded-modal bg-white/95 backdrop-blur-2xl"
...
export function Modal({ isOpen, onClose, title, children }: { isOpen: boolean, onClose: () => void, title?: string, children: React.ReactNode }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[rgba(15,23,42,0.60)] backdrop-blur-sm animate-fadeIn">
      <div className="w-full max-w-md bg-white/95 backdrop-blur-2xl border border-white/60 rounded-modal shadow-floating overflow-hidden animate-scaleIn flex flex-col max-h-[90vh]">
