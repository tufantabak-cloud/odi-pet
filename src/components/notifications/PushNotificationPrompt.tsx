...
export default function PushNotificationPrompt() {
  ...
  useEffect(() => {
    ...
    // Yalnızca izin istenmemişse (default) ve tarayıcı destekliyorsa göster
    if (permission === 'default') {
      // Yüklenir yüklenmez çıkmaması için ufak bir gecikme ekliyoruz
  ...
  return (
    <div className="bg-primary-soft/30 border border-primary/20 rounded-[20px] p-4 flex flex-col sm:flex-row items-center justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500 mb-2 relative overflow-hidden">
