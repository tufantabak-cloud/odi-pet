...
export default function FloatingSOS() {
  ...
  return (
    <>
      {/* SOS Modal Overlay */}
      {open && (
        <div className="fixed inset-0 z-[9998] bg-black/50 backdrop-blur-sm flex items-end justify-center p-4"
          onClick={() => setOpen(false)}>
          <div className="w-full max-w-sm bg-surface rounded-[28px] p-7 shadow-2xl"
