...
- Name: smart_scanner.spec.ts >> Akıllı Tarama (Smart Scanner) Akışı >> Mama paketi taraması ve mama bitiş tarihi hesaplaması kontrolü
- Location: e2e\smart_scanner.spec.ts:114:7
