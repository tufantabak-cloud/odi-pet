...
- Name: main_flow.spec.ts >> Odi.Pet E2E Automation Robot >> 3. Pet Profile and Appointments Stage
- Location: e2e\main_flow.spec.ts:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/owner/pets
Call log:
  - navigating to "http://localhost:3000/owner/pets", waiting until "load"
