-- =============================================================================
-- Feature Registry - Phase 17.5: Fix Consume RPC & Enhance Idempotency
-- Migration : 20260807060000_fix_consume_rpc_and_idempotency.sql
-- =============================================================================
...
BEGIN
  ...
  IF v_limit_record.limit_type = 'quota' THEN
    ...
    VALUES (p_profile_id, p_feature_key, p_pet_id, v_new_usage, now(), v_reset_at)
