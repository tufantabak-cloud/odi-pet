...
INSERT INTO public.parasite_products
  (species, name, brand, type, application_method, active_ingredient, protection_duration_days, description, is_active, status)
VALUES

-- Köpek - Yeni ürünler
('dog','Credelio','Elanco','external','oral','Lotilaner',35,
 'Köpeklerde pire ve kene koruması sağlayan 35 günlük küçük çiğneme tableti. Yemekle birlikte verilir.', true, 'approved'),

('dog','Bravecto Plus Köpek','MSD Animal Health','combined','spot-on','Fluralaner + Moksidestin',84,
 'Köpeklerde 3 aylık pire, kene ve iç parazit koruması sağlayan kombine spot-on.', true, 'approved'),

('dog','Vectra 3D','Ceva','external','spot-on','Dinotefuran + Permethrin + Pyriproxyfen',30,
 'Köpeklerde pire, kene ve sivrisinekten aylık spot-on koruma. Kedilere toksik, dikkat.', true, 'approved'),

('dog','Advantix Köpek','Bayer/Elanco','external','spot-on','İmidakloprid + Permethrin',30,
 'Köpeklerde pire, kene, sivrisinek ve tatarcığa karşı aylık spot-on. Kedilere uygulanmaz.', true, 'approved'),

('dog','Milpro Köpek','Virbac','internal','oral','Milbemisin Oksim + Prazikuantel',90,
 'Köpekler için yuvarlak ve yassı kurt tedavisi. 3 ayda bir uygulanır.', true, 'approved'),

('dog','Simparica','Zoetis','external','oral','Sarolaner',35,
 'Köpeklerde pire ve kene koruması sağlayan 35 günlük oral tablet.', true, 'approved'),

('dog','Capstar Köpek','Elanco','external','oral','Nitenpyram',1,
 'Köpeklerde anlık pire öldürücü tablet. 30 dakikada etki gösterir, 24 saatlik koruma.', true, 'approved'),

-- Kedi - Yeni ürünler
('cat','Credelio Cat','Elanco','external','oral','Lotilaner',35,
 'Kedilerde pire koruması sağlayan 35 günlük küçük oral tablet.', true, 'approved'),

('cat','Bravecto Plus Kedi','MSD Animal Health','combined','spot-on','Fluralaner + Moksidestin',84,
 'Kedilerde 3 aylık pire, kene ve iç parazit koruması sağlayan kombine spot-on.', true, 'approved'),

('cat','Milpro Kedi','Virbac','internal','oral','Milbemisin Oksim + Prazikuantel',90,
 'Kediler için yuvarlak ve yassı kurt tedavisi. 3 ayda bir uygulanır.', true, 'approved'),

('cat','Vectra Felis','Ceva','external','spot-on','Dinotefuran + Pyriproxyfen',30,
 'Kedilerde pire ve bit koruması sağlayan aylık spot-on.', true, 'approved'),

('cat','Capstar Kedi','Elanco','external','oral','Nitenpyram',1,
 'Kedilerde anlık pire öldürücü tablet. 30 dakikada etki gösterir, 24 saatlik koruma.', true, 'approved'),

('cat','Revolution Plus Kedi','Zoetis','combined','spot-on','Selamektin + Sarolaner',30,
 'Kedilerde pire, kene, kulak akarı ve iç parazite karşı aylık kombine spot-on.', true, 'approved'),

-- Her iki tür için
('both','Interceptor','Virbac','internal','oral','Milbemisin Oksim',30,
 'Kedi ve köpekler için heartworm dahil geniş spektrum iç parazit koruması. Aylık oral tablet.', true, 'approved'),

('both','Drontal','Bayer/Elanco','internal','oral','Prazikuantel + Pirantel',90,
 'Kedi ve köpekler için yuvarlak ve yassı kurt tedavisi. 3 ayda bir uygulanır.', true, 'approved');
