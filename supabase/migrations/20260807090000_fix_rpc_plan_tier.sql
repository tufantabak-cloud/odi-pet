-- =============================================================================
-- Feature Registry - Phase 17.5: Fix RPC Premium Tier Crash
-- Migration : 20260807070000_fix_rpc_premium_tier_crash.sql
-- =============================================================================
...
BEGIN
  ...
  -- C. Fetch User Plan
  -- We assume 'free' as baseline. In a fully completed Phase 18, this should query active subscriptions.
  -- For now, removing the legacy premium_tier column reference to avoid crashes.
  v_user_plan := 'free';
